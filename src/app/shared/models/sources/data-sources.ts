...
import {Instiller} from './instiller';
...
export class DataSources {
    ...
    public constructor(
        ...
        this.sources.push(new Instiller());
...
//        this.sources.push(new Woocommerce());
    ...
    public setIntegrationsNavigation(integrationsItem: FuseNavigationItem): void {
        if (this.isLoggedIn) {
            ...
            const instillerItem = ({
                id: 'integrations.instiller',
                title: 'Instiller',
                type: 'basic',
                disabled: !this.canClientAdmin,
                icon: 'heroicons_outline:mail',
                link: '/integrations/instiller'
            } as FuseNavigationItem);
            ...
            this.activeDescriptions.forEach(activeDescription => {
                ...
                if (activeDescription.name === 'instiller') {
                    this.addIntegrationChild(integrationsItem, instillerItem);
                }
