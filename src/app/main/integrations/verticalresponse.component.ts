...
@Component({
    selector: 'verticalresponse',
    templateUrl: './verticalresponse.component.html',
    animations: fuseAnimations
})

export class VerticalresponseComponent implements OnInit, OnDestroy {
    ...
    syncLists(): void {
        ...
        this.httpService.getEntity('sync-lists', 'verticalresponse')
            .subscribe(result => {
    ...
    syncMembers(): void {
        this.httpService.getEntity('sync-list-members', 'verticalresponse')
            .subscribe(result => {
    ...
    syncCampaigns(): void {
        ...
        this.httpService.getEntity('sync-campaigns', 'verticalresponse')
            .subscribe(result => {
    ...
    syncActivity(): void {
        this.httpService.getEntity('sync-activity', 'verticalresponse')
            .subscribe(result => {
