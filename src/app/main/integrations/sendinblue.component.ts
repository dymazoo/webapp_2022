...
export class SendinblueComponent implements OnInit, OnDestroy {
    ...
    syncLists(): void {
        ...
        this.httpService.getEntity('sync-lists', 'sendinblue')
            .subscribe(result => {
    ...
    syncCampaigns(): void {
        ...
        this.httpService.getEntity('sync-campaigns', 'sendinblue')
            .subscribe(result => {
    ...
    syncActivity(): void {
        this.httpService.getEntity('sync-activity', 'sendinblue')
            .subscribe(result => {
