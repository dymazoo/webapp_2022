...
@Component({
    selector: 'instiller',
    templateUrl: './instiller.component.html',
    animations: fuseAnimations
})

export class InstillerComponent implements OnInit, OnDestroy {
    ...
    syncLists(): void {
        ...
        this.httpService.getEntity('sync-lists', 'instiller')
            .subscribe(result => {
    ...
    syncMembers(): void {
        this.httpService.getEntity('sync-list-members', 'instiller')
            .subscribe(result => {
    ...
    syncCampaigns(): void {
        ...
        this.httpService.getEntity('sync-campaigns', 'instiller')
            .subscribe(result => {
    ...
    syncActivity(): void {
        this.httpService.getEntity('sync-activity', 'instiller')
            .subscribe(result => {
